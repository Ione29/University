object FSets {
  ...
  //9. Implement an alternative to the previous function, namely foldRight. Applying foldRight on the set {x,y,z} with initial value b should produce: a op (b op (c op b)). Use direct recursion instead of tail recursion.
